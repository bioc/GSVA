...
applications. The interested reader is referred to \citep{GSVA_in_press} for
...
are due to the limited number of times we repeat the simulation; see \citet{GSVA_in_press}
